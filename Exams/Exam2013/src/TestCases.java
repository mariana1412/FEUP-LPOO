...
public class TestCases {
    ...
    public void testExcepcoes() throws Exception{
        new Circulo(new Ponto(1, 5), -1);
    }

    @Test
    public void testFigura() throws Exception {
    ...
    @Test
    public void testFiguraComposta() throws Exception {
    ...
    @Test
    public void testCountable() throws Exception {
        Circulo c = new Circulo(new Ponto(2, 2), 1);
        Rectangulo r = new Rectangulo(0, 0, 1, 1);
        Figura[] figuras = new Figura[] {c, r};
